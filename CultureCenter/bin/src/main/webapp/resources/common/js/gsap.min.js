...
! function(t, e) {
    ...
    function id(t, e) {
        var r = oe.createElementNS ? oe.createElementNS((e || "https://www.w3.org/1999/xhtml").replace(/^https/, "http"), t) : oe.createElement(t);
    ...
    function nd(t) {
        var e, r = id("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "https://www.w3.org/2000/svg"),
            i = this.parentNode,
            n = this.nextSibling,
