...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/information/application/index.do" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/information/application/index.do">
	<div class="navi_wrap">
    ...
    <div class="cont_inner no_pb">
		...
		<a class="" href="/information/branch/list.do"><p class="f_desc">지점안내</p></a>	
			...
			<a class="" href="/information/faq/list.do"><p class="f_desc">자주하는 문의</p></a>	
                ...
                <!-- 2023-01-16 삭제
                <div class="txt_wrap">
                    <p class="txt f_desc">강사지원쪽 세부 설명 으로 이동</p>
                    <p class="desc">롯데백화점 문화센터에 전문 강사로 지원하시기 위해서는 L.POINT 회원 가입 후 지원이 가능합니다.</p>
                </div>
                // 2023-01-16 삭제 -->
            </div>
					...
					<div class="left box active">
						<a href="javascript:" onclick="requestIndexCtrl.getLayer('teacher');">
							<div class="img_resize_w img">
								<img src="/common/images/@img-userinfo-divide-left.jpg" alt="">
							</div>
							<div class="inner_box">
								<p class="txt">롯데문화센터 <br class="only_pc">강사지원</p>
								<p class="desc_txt">분야별 수준 높은 교육문화 컨텐츠와 열정적인 전문 강사님을 모십니다.</p><!-- 2023-01-16 텍스트 수정 -->
								<p class="arrow_btn"><span>지원하기</span></p>
							</div>
						</a>
					</div>
					<div class="right box">
						<a href="javascript:" onclick="requestIndexCtrl.getLayer('cooper');">
							<div class="img_resize_w img">
								<img src="/common/images/@img-userinfo-divide-right.jpg" alt="">
							</div>
							<div class="inner_box">
								<p class="txt">롯데문화센터 <br class="only_pc">제휴신청</p>
								<p class="desc_txt">콘텐츠·서비스·비즈니스· 마케팅·광고 등 <br>Lifestyle LAB과 함께할 파트너사의 <br>소중한 제안을 기다리고
									있습니다.</p>
								<p class="arrow_btn"><span>신청하기</span></p>
							</div>
						</a>
					</div>
				</div>
...
<div id="application_popup" class="layer_popup" style="display:none">
    <div class="pop_wrap w800 full">
        ...
        <div id="popupContent" class="pop_cont">
...
<script type="text/javascript" src="/common/js/information/teacherApp/requestIndex.js"></script>

<script type="text/javascript" src="/common/js/information/teacherApp/teacherRequest.js"></script>
<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-serialize-object/2.5.0/jquery.serialize-object.min.js"></script>

<script type="text/javascript" src="/common/js/information/teacherApp/cooperationRequest.js"></script><footer>
