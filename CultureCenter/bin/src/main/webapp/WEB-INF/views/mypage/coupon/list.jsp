...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/coupon/list.do" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/coupon/list.do">
	<div class="navi_wrap">
					...
					<div class="fixed_mobile_w">
						<div class="fixed_mobile">
							<div class="filter_bar_div">
								<div class="left">
									<p class="f_caption2">
										나의 쿠폰 <span class="point" id="totCnt"></span>개
									</p>
								</div>
								<div class="right">
									<div class="btn_area">
...
<script type="text/javascript" src="/common/js/mypage/mypageCoupon.js"></script><footer>
