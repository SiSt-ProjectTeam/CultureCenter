...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/myreview/list.do?pageIndex=1&listCnt=10&initIndex=1&yy=2023&lectSmsterCd=4" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/myreview/list.do">
	<div class="navi_wrap">
	...
	<!-- 2022-12-05 추가 -->
</div><form id="reviewForm" data-page-type="list">
    ...
    <div class="cont_wrap">
                ...
                <div class="inner">
                    <div class="top_area">
                        ...
                        <a href="javascript:" class="tit_div arrow" title="페이지 이동 팝업 열기">
                            <p class="tit f_h1">나의 수강후기 <span class="more_tit"></span></p>
                        </a>
                        <div class="tit_popup">
                            <div class="pop_wrap">
                                <div class="pop_cont">
    	...
    	<a class="" href="/mypage/member/info.do"><p class="f_desc">회원정보변경</p></a>
       	...
       	<a class="active" href="/mypage/myreview/list.do"><p class="f_desc">나의 수강후기</p></a>
                                            ...
                                            <div class="btn_wrap">
                                                ...
                                                <div class="filter_list_wrap">
                                                    ...
                                                    <div class="scroll_wrap">
                                                        <a class="txt f_caption2 on" data-value="2023" href="javascript:" onclick="myreviewCtrl.searchOpt(this);">2023년</a>
                                                        <a class="txt f_caption2 " data-value="2022" href="javascript:" onclick="myreviewCtrl.searchOpt(this);">2022년</a>
                                                        </div>
                                                </div>
                                            </div>
                                            <div class="btn_wrap">
                                                ...
                                                <div class="filter_list_wrap">
                                                    ...
                                                    <div class="scroll_wrap">
                                                        <a class="txt f_caption2 " data-value="1" href="javascript:" onclick="myreviewCtrl.searchOpt(this);">봄학기</a>
                                                        <a class="txt f_caption2 " data-value="2" href="javascript:" onclick="myreviewCtrl.searchOpt(this);">여름학기</a>
                                                        <a class="txt f_caption2 " data-value="3" href="javascript:" onclick="myreviewCtrl.searchOpt(this);">가을학기</a>
                                                        <a class="txt f_caption2 on" data-value="4" href="javascript:" onclick="myreviewCtrl.searchOpt(this);">겨울학기</a>
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript" src="/common/js/mypage/myreviewController.js"></script><footer>
