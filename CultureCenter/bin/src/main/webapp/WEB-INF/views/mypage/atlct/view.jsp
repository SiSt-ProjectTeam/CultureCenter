...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/atlct/view.do?pageIndex=1&type=rfnd&lectSmsterCd=&yy=&q=&atlctRsvNo=2340002m5Lzp&initIndex=1&listCnt=6&prevSesterYy=2023&prevSesterLectSmsterCd=3" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/atlct/view.do">
	<div class="navi_wrap">
	...
	<!-- 2022-12-05 추가 -->
</div><div class="cont_wrap" data-page-type="view">
	<form id="frm_update" name="frm_update">
		<input type="hidden" name="csrfPreventionSalt" value="t4o3WqPtK4rgZj48oaDy" />
		<input type="hidden" id="atlctRsvNo" name="atlctRsvNo" value="2340002m5Lzp" />
	...
	<div class="cont_inner no_pb">
		<div class="page_title_area"> <!-- 2022-11-28 클래스 추가 -->
			<div class="inner">
				<div class="top_area">
			...
			<div class="inner pay_info">
				<div class="sub_inner_w">
						...
						<div class="form_table">
							<table>
								...
								<tbody>
									<tr>
										<th>
											<p class="f_body1">주문번호</p>
										</th>
										<td class="ta_left">
											<p class="f_body2">2340002m5Lzp</p>
										</td>
									</tr>
									<tr>
										<th>
											<p class="f_body1">결제채널</p>
										</th>
										<td class="ta_left">
											<p class="f_body2">온라인</p>
										</td>
									</tr>
									<tr>
										<th>
											<p class="f_body1">결제일</p>
										</th>
										<td class="ta_left">
											<p class="f_body2">2023.11.16 00:16</p>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<div class="cour_his_list">
			                      <div class="cour_top_area">
			                        <div class="left">
			                          ...
			                          <p class="tit f_h2">
			                          	<a href="/application/search/view.do?brchCd=0001&yy=2023&lectSmsterCd=4&lectCd=0494">[12/7] 신형철 평론가의 영상시대의 문학: 인지적 공감을 위하여</a>
			                          </p>
			                        </div>
			                        <div class="right">
			                          <ul class="txt_wrap">
			                            ...
			                            <li class="dl f_body2">
			                              ...
			                              <p class="dd f_body1">2023.12.07 ~ 2023.12.07 (목) 19:00~20:30 / 1회 </p>
			                            </li>
			                          </ul>
			                          <ul class="txt_wrap">
			                            <li class="dl f_body2">
			                              <p class="dt">강좌료<span class="colon">:</span></p>
			                              <p class="dd f_body1">5,000원</p>
			                            </li>
			                            </ul>
			                        </div>
			                      </div>
			                      <div class="cour_detail_w plural">
			                      	<div class="cour_detail ">
				                          ...
				                          <div class="right">
				                            ...
				                            <p class="caution f_caption2">취소(환불) 사유 : 고객변심</p>
				                            	</div>
				                        </div>
			                        <div class="cour_detail ">
				                          <div class="left">
				                          	<div class="tit f_body1">ddddd(자녀)</div>
				                          		</div>
				                          <div class="right">
				                            <ul class="txt_wrap">
				                              <li class="f_body3">
				                            ...
				                            <p class="caution f_caption2">취소(환불) 사유 : 기타</p>
				                            	</div>
				                        </div>
			                        </div>
			                    </div>
	                ...
	                <div class="flex_btn_wrap no_pb margin_large">
	                  <a class="border_btn" href="/mypage/atlct/list.do?pageIndex=1&type=rfnd&lectSmsterCd=&yy=&q=&atlctRsvNo=2340002m5Lzp&initIndex=1&listCnt=6&prevSesterYy=2023&prevSesterLectSmsterCd=3">
	                    <span>이전</span>
	                  </a>
	                </div>
	                <!-- // 2022-12-22 추가 -->
							...
							<div class="form_select_div w100p">
								...
								<div class="list_wrap rfndRsn">
									...
									<div class="scroll_wrap">
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="01"><span>고객변심</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="02"><span>컴플레인</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="03"><span>이사</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="04"><span>강사불만</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="05"><span>강좌불만</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="06"><span>폐강</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="07"><span>기타</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="08"><span>강좌변경</span></a>
										<a class="btn_link" href="javascript:" data-rfnd-rsn-cd="09"><span>결제형태 변경</span></a>
										</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript" src="/common/js/mypage/mypage_atlct.js"></script><footer>
