...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/teachereval/list.do?pageIndex=1&listCnt=10&initIndex=1" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/teachereval/list.do">
	<div class="navi_wrap">
	...
	<!-- 2022-12-05 추가 -->
</div><form id="teacherEvalForm" data-page-type="list">
...
<script type="text/javascript" src="/common/js/mypage/teacherEvalController.js"></script><footer>
