...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/inquiry/list.do?status=&pageIndex=1&initIndex=1&listCnt=10" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/inquiry/list.do">
	<div class="navi_wrap">
...
<a class="txt f_caption2 on" href="javascript:mypageInquiryCtrl.selectStatus('');">전체</a>
						                                <a class="txt f_caption2" href="javascript:mypageInquiryCtrl.selectStatus('N');">접수중</a>
						                                <a class="txt f_caption2" href="javascript:mypageInquiryCtrl.selectStatus('Y');">답변완료</a>
</div>
											</div>
										</div>
									</div>
...
<script type="text/javascript" src="/common/js/mypage/mypageInquiryCtrl.js"></script><script type="text/javascript" src="/common/js/mypage/mypageInquiryCtrl.js"></script><footer>
