...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/atlct/list.do?pageIndex=1&type=rfnd&lectSmsterCd=&yy=&q=&atlctRsvNo=&initIndex=1&listCnt=6&prevSesterYy=2023&prevSesterLectSmsterCd=3" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/atlct/list.do">
	<div class="navi_wrap">
	...
	<!-- 2022-12-05 추가 -->
</div><div class="cont_wrap" data-page-type="list">
	<form id="frm_search" name="frm_search">
		<input type="hidden" id="pageIndex" name="pageIndex" value="1"/>
		<input type="hidden" id="type" name="type" value="rfnd" />
						...
						<div class="filter_bar_area no_padding">
		                    <div class="border_tab_area">
		                      <div class="swiper-container">
		                        <div class="swiper-wrapper">
		                          <a href="/mypage/atlct/list.do?type=cmplt" class="swiper-slide "><span>수강내역 조회</span></a>
		                          <a href="/mypage/atlct/list.do?type=rfnd" class="swiper-slide on"><span>취소내역 조회</span></a>
		                        </div>
		                      </div>
		                    </div>
		                </div>
