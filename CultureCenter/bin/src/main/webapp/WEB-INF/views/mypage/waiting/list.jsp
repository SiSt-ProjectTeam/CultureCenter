...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/waiting/list.do?pageIndex=1&brchCd=&initIndex=1&listCnt=6" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/waiting/list.do">
	<div class="navi_wrap">
	...
	<!-- 2022-12-05 추가 -->
</div><form id="frm_submit" name="frm_submit">
	<input type="hidden" name="csrfPreventionSalt" value="5J8tc1q8uIX3wqnjNd1M" />
	<input type="hidden" name="jsonStr" value="" />
	<input type="hidden" name="atlctRsvNo" value="" />
	<input type="hidden" name="atlctType" value="waiting" />
</form>

<form id="frm_cancel" name="frm_cancel">
	<input type="hidden" name="atlctRsvNo" value="" />
	<input type="hidden" name="lectNm" value="" />
	<input type="hidden" name="optnNm" value="" />
	<input type="hidden" name="lectStDtm" value="" />
	<input type="hidden" name="lectSt" value="" />
</form>
...
<div class="cont_wrap">
	...
	<div class="cont_inner no_pb">
            ...
            <div class="inner">
				<div class="top_area">
					...
					<a href="javascript:" class="tit_div arrow" title="페이지 이동 팝업 열기">
						<p class="tit f_h1">대기자 조회 <span class="more_tit"></span></p>
					</a>
					<div class="tit_popup">
						<div class="pop_wrap">
							<div class="pop_cont">
    	...
    	<a class="" href="/mypage/member/info.do"><p class="f_desc">회원정보변경</p></a>
       	...
       	<a class="active" href="/mypage/waiting/list.do"><p class="f_desc">대기자 조회</p></a>
		...
		<div class="page_cont_area">
			<div class="inner pay_info dual_list">
				<div class="wating_w">
					<div class="dot_txt_box">
	                  <p class="dot_txt">기존 회원의 수강신청 취소로 접수가 가능해지면 대기순번에 따라 문자(카카오톡)로 알려드리며 알림 후 12시간 동안 수강신청이 가능합니다.</p>
	                  <p class="dot_txt">대기강좌의 수강기간이 종료 시 대기강좌 목록에서 최대 3개월까지 보관 됩니다.</p>
	                  <p class="dot_txt">대기접수 상태에서 추가로  동반 수강자 선택이 필요하거나, 재료비 또는 대여료 추가해야 할 경우 이전 대기접수 신청 건을 삭제 후 재신청 하셔야 합니다.</p>
	                </div>
	                          ...
	                          <div class="btn_area">
	                            <div class="btn_wrap">
	                              <div class="filter_open_area">
	                              	<a href="javascript:" class="btn dropdown_btn filter_popup_btn" title="컨텐츠정렬 팝업 열기"><div class="order_txt">전체지점</div></a>
	                              </div>
	                              <div class="dimd"></div>
	                              <div class="filter_list_wrap">
	                                ...
	                                <div class="scroll_wrap">
	                                	<a class="txt f_caption2 on" href="javascript:mypage_waiting.changeBrchCd('')">전체지점</a>
	                                	<p class="sub_tit only_mobile">서울점</p>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0002')">잠실점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0001')">본점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0013')">강남점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0028')">건대스타시티점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0006')">관악점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0340')">김포공항점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0022')">노원점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0026')">미아점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0010')">영등포점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0004')">청량리점</a>
											<p class="sub_tit only_mobile">수도권점</p>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0344')">인천점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0399')">동탄점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0335')">구리점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0008')">분당점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0349')">수원점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0336')">안산점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0011')">일산점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0334')">중동점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0341')">평촌점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0350')">롯데몰광명점</a>
											<p class="sub_tit only_mobile">지방점</p>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0005')">부산본점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0333')">광복점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0007')">광주점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0023')">대구점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0012')">대전점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0016')">동래점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0354')">마산점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0024')">상인점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0027')">센텀시티점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0015')">울산점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0025')">전주점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0017')">창원점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0014')">포항점</a>
											<a class="txt f_caption2 " href="javascript:mypage_waiting.changeBrchCd('0361')">롯데몰군산점</a>
											</div>
	                              </div>
	                            </div>
	                          </div>
...
<script type="text/javascript" src="/common/js/mypage/mypage_waiting.js"></script><footer>
