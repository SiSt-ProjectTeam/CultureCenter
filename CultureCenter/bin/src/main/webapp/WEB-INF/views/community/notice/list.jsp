...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/community/notice/list.do?brchCd=&clCd=8&notcSeqno=&q=&pageIndex=1&initIndex=1&listCnt=10" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/community/notice/list.do">
	<div class="navi_wrap">
	...
	<div class="cont_inner no_pb">
		<form id="frmSearch" name="frmSearch">
		    ...
		    <input type="hidden" id="clCd" 	 	 name="clCd"	   value="8">
													...
													<div class="btn_wrap">
														...
														<div class="filter_list_wrap">
															...
															<div class="scroll_wrap">
																<a class="txt f_caption2 on" href="javascript:noticeCtrl.selectBrch('');">전체지점</a>
									                            <p class="sub_tit only_mobile">서울점</p>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0002');" data-brch-cd="0002" >잠실점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0001');" data-brch-cd="0001" >본점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0013');" data-brch-cd="0013" >강남점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0028');" data-brch-cd="0028" >건대스타시티점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0006');" data-brch-cd="0006" >관악점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0340');" data-brch-cd="0340" >김포공항점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0022');" data-brch-cd="0022" >노원점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0026');" data-brch-cd="0026" >미아점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0010');" data-brch-cd="0010" >영등포점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0004');" data-brch-cd="0004" >청량리점</a>
										                            <p class="sub_tit only_mobile">수도권점</p>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0344');" data-brch-cd="0344" >인천점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0399');" data-brch-cd="0399" >동탄점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0335');" data-brch-cd="0335" >구리점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0008');" data-brch-cd="0008" >분당점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0349');" data-brch-cd="0349" >수원점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0336');" data-brch-cd="0336" >안산점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0011');" data-brch-cd="0011" >일산점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0334');" data-brch-cd="0334" >중동점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0341');" data-brch-cd="0341" >평촌점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0350');" data-brch-cd="0350" >롯데몰광명점</a>
										                            <p class="sub_tit only_mobile">지방점</p>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0005');" data-brch-cd="0005" >부산본점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0333');" data-brch-cd="0333" >광복점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0007');" data-brch-cd="0007" >광주점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0023');" data-brch-cd="0023" >대구점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0012');" data-brch-cd="0012" >대전점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0016');" data-brch-cd="0016" >동래점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0354');" data-brch-cd="0354" >마산점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0024');" data-brch-cd="0024" >상인점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0027');" data-brch-cd="0027" >센텀시티점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0015');" data-brch-cd="0015" >울산점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0025');" data-brch-cd="0025" >전주점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0017');" data-brch-cd="0017" >창원점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0014');" data-brch-cd="0014" >포항점</a>
										                            <a class="txt f_caption2 " href="javascript:noticeCtrl.selectBrch('0361');" data-brch-cd="0361" >롯데몰군산점</a>
										                            </div>
														</div>
													</div>
												</div>
...
<script type="text/javascript" src="/common/js/community/noticeCtrl.js"></script><footer>
