...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/community/review/list.do?pageIndex=1&listCnt=5&initIndex=1&q=&orderSet=&brchCd=" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/community/review/list.do">
	<div class="navi_wrap">
