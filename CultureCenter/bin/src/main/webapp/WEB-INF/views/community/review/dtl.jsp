...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/community/review/dtl.do?pageIndex=1&listCnt=10&initIndex=1&brchCd=0344&yy=2023&lectSmsterCd=3&lectCd=0591&tcCdNo=026577&memberNo=231098323&sortSeqno=&cmntCont=" id="og-url-value"/>
		<meta property="og:title" content="정말 좋으신 바이올린 선생님" id="og-title-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/community/review/dtl.do">
	<div class="navi_wrap">
	...
	<!-- 2022-12-05 추가 -->
</div><form id="reviewForm" data-page-type="dtl">
    <input type="hidden" id="pageIndex" name="pageIndex" value="1"/>
    <input type="hidden" id="listCnt" name="listCnt" value="10"/>
    <input type="hidden" id="initIndex" name="initIndex" value="1"/>
    
    <input type="hidden" name="brchCd" value="0344" />
    <input type="hidden" name="yy" value="2023" />
    <input type="hidden" name="lectSmsterCd" value="3" />
    <input type="hidden" name="lectCd" value="0591" />
    <input type="hidden" name="tcCdNo" value="026577" />
    <input type="hidden" name="memberNo" value="231098323" />
            ...
            <div class="view_con_w">
                <div class="view_con review_con">
                    <div class="top_area">
                        <div class="type_div">
                            <p class="type">곽*현</p>
                            <p class="type">2023.11.29</p>
                        </div>
                        <div class="share_area only_pc">
                            <!-- 2022-11-23 class 추가 -->
                            <a href="javascript:commonScript.openPopupFn('#sharePop');" class="share_btn" title="공유하기"></a>
                        </div>
                        <p class="title">정말 좋으신 바이올린 선생님</p>
                    ...
                    <div class="content">
                        <div class="txt f_body2">
                            개인사정으로 겨울 학기는 등록하고 취소했지만 계속 배우고 싶은 선생님입니다. 성격도 좋으시고, 편안하게 해주시고, 무엇보다 무엇이 부족한지 바로 아시고 지도해주세요. 기초가 없었는데, 배워나가는 중에 중단하여 저도 좀 그렇네요 ㅠ쉬는&#40;?&#41; 동안 가을 학기 때 배운거 꾸준히 복습하고 있을게요. <br> <!-- 2023-02-09 br추가, 링크추가-->
                            ...
                            <div class="thum_list_wrap">
                                ...
                                <a href="/application/search/view.do?brchCd=0344&yy=2023&lectSmsterCd=3&lectCd=0591" class="thum_list" >
                                    ...
                                    <div class="txt_wrap">
                                        <div class="thum_left">
                                            <div class="label_div">
                                                <p class="label small light_gray">강의종료</p>
                                                <p class="label small border">성인강좌</p>
                                                <p class="label small border">악기</p>
                                            </div>
                                            <p class="title limit_line_two">토]프라이빗 1:1 바이올린 레슨_C</p>
                                        </div>
                                        <div class="thum_right">
                                            <div class="type_div">
                                                <p class="type f_caption2">인천점</p>
                                                <p class="type f_caption2">정순효</p>
                                                <p class="type contour f_caption2">가을학기</p>
                                                <p class="type contour f_caption2">2023.09.02 ~ 2023.11.25</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
