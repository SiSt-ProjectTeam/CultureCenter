...
<html lang="ko">
	<head>
		...
		<title>		
			LIFESTYLE LAB 매거진 > 커뮤니티 > 롯데문화센터</title>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/community/magazine/list.do?pageIndex=1&initIndex=1&listCnt=10" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/community/magazine/list.do">
	<div class="navi_wrap">
	...
	<div class="cont_inner no_pb">
		<form id="frmMagazine" name="frmMagazine">
			...
			<div class="inner">
				<div class="top_area">
					...
					<a href="javascript:" class="tit_div arrow" title="페이지 이동 팝업 열기">
						<p class="tit f_h1">LIFESTYLE LAB 매거진<span class="more_tit"></span></p>
					</a>
					<div class="tit_popup">
						<div class="pop_wrap">
							<div class="pop_cont">
		...
		<a class="" href="/community/notice/list.do"><p class="f_desc">공지사항/이벤트</p></a>	
			...
			<a class="active" href="/community/magazine/list.do"><p class="f_desc">LIFESTYLE LAB 매거진</p></a>	
			</div></div>
								</div>
							</div>
						</div>
		...
		<div class="page_cont_area no_pt">
			<div class="inner">
						<div class="magazine_visual">
					<div class="bg" style="background:url('https://culture.lotteshopping.com/files/CUL_ONL/2023/10/202310310429057100.png') no-repeat center center/cover"></div><!-- 아래에 img태그와 동일하게 넣어주세요 -->
					<a href="/community/magazine/view.do?webMgznSeqno=52" class="visual_inner">
						<div class="txt_box">
							<p class="title limit_line_two">찻잔 가득 일렁이는 진심<p class="date">
								오므오트</p>
						</div>
						<div class="img_area">
							<div class="img">
<!-- 								<img src="/common/images/img-magazine-17.jpg" alt=""> -->
								<img src="https://culture.lotteshopping.com/files/CUL_ONL/2023/10/202310310429057100.png" alt="오므오트 썸네일.png"> <!-- onerror="'this.src=/common/images/img-magazine-17.jpg'"  -->
									</div>
						</div>
					</a>
				</div>
					...
					<div class="fixed_mobile_w">
						<div class="fixed_mobile">
							<div class="filter_bar_div">
								<div class="left">
									<p class="f_caption2">전체 <span class="point" id="totCnt"></span></p>
								</div>
								<div class="right"></div>
							</div>
						</div>
				...
				<div class="magazine_list_w" id="listContainer">
...
<script type="text/javascript" src="/common/js/community/webMagazineCtrl.js"></script><footer>
