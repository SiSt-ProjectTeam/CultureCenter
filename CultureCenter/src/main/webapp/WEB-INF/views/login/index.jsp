...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/login/index.do?rtnUrl=%2Findex.do" id="og-url-value"/>
						...
						<div class="login_box">
							...
							<div class="inner">
								<div class="form_input login_id">
									...
									<input type="text" id="mbrId" onkeyup="if(window.event.keyCode == 13) members.login();" placeholder="아이디 또는 이메일을 입력해주세요." title="아이디(이메일)" value="">
								</div>
								<div class="form_input login_pw">
									<!-- 2022-11-23 클래스 추가-->
									<input type="password" id="mbrPwd" onkeyup="if(window.event.keyCode == 13) members.login();" placeholder="비밀번호를 입력해주세요." title="비밀번호" value="">
									<div class="input_btn_wrap">
								...
								<div class="find_account">
									<a href="javascript:members.callScreen('fdIdUrl')" class="find_id f_body4">아이디 찾기</a> 
									<a href="javascript:members.callScreen('fdPwdUrl')" class="find_pw f_body4">비밀번호 찾기</a>
								</div>
							</div>
							<!-- // 2022-11-23 구조 수정 -->
						</div>
