...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/login/logout.do?ssoTkn=&acesTkn=&rnwTkn=&onlCstTpC=&frnYn=&rspClac=&rspC=&rspDtc=&rspMsgCn=&rtnUrl=" id="og-url-value"/>
	...
	<div class="cont_inner">
		...
		<div class="page_cont_area no_pb">
			<div class="inner">
				...
				<p class="txt f_body1">
					롯데백화점 문화센터를 이용해 주셔서 감사합니다.<br> 
					행복한 하루 되시기 바랍니다.<br>
				</p>
				<div class="flex_btn_wrap margin_large">
					<a class="b_color_btn white" href="/"> <span>메인으로</span></a> 
