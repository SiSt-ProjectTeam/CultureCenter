	...
	<div class="cont_inner no_pb">
			...
			<div class="inner">
				<div class="top_area">
					...
					<a href="javascript:" class="tit_div arrow" title="페이지 이동 팝업 열기">
						<p class="tit f_h1">
							회원정보변경 <span class="more_tit"></span>
						</p>
					</a>
					<div class="tit_popup">
						<div class="pop_wrap">
							<div class="pop_cont">
								<div class="for_padding">
									<div class="scroll_area">
										<div class="branch">
											<a class="active" href="/mypage/member/info.do"><p
													class="f_desc">회원정보변경</p></a> <a class=""
												href="/mypage/atlct/list.do"><p class="f_desc">수강내역
													조회</p></a> <a class="" href="/mypage/waiting/list.do"><p
		...
		<div class="page_cont_area">
			<div class="inner">
				<div class="sub_inner_w change_info">
					<div class="sub_inner">
						...
						<div class="other_info">
							...
							<div class="flex_btn_wrap">
								<a class="border_btn"
									href="javascript:members.callScreen('chPwdUrl')"><span>비밀번호
										변경</span></a> <a class="border_btn"
									href="javascript:members.callScreen('mbrMngUrl')"><span>회원정보
										변경</span></a>
							</div>
						</div>
					</div>
					<div class="sub_inner">
						<div class="sub_tit_area"
							...
							<div class="right">
								<p class="f_h2 red_txt">[선택] 마케팅 활용 및 광고성 정보 수신 동의</p>
							</div>
						</div>
						<div class="info_txt">
							<p class="f_body2">
								백화점 마케팅 수신동의와 별개로, 문화센터 강좌수강 및 학습활동과 관련된 정보 및 소식을 받아보실 수 있습니다.<br>
								<br> 1. 수집 목적 : 롯데문화센터 접수 및 강좌 안내, 강좌 추천<br> 2. 수집 항목
								: 성명, 휴대전화번호, 관심지점<br> 3. 보유 기간 : 회원 탈회시 까지<br> 4.
								거부권/불이익 : 활용 동의를 거부할 수 있으나, 강좌 추천 및 안내를 받을 수 없음<br> ※ 서비스
								주요 정책 및 공지사항 안내 등은 수신동의 여부와 상관없이 발송됩니다.<br>
							</p>
						</div>
								...
								<div class="form_checkbox">
									<div>
										<input type="checkbox" id="checkMKTG"
											onclick="javascript:mypageMember.blockMKTG()"> <label
											for="checkMKTG">[선택] 문화센터 마케팅 활용 동의</label>
									</div>
									<div>
										<input type="checkbox" id="checkSMS"
											onclick="javascript:mypageMember.blockSMS()"> <label
											for="checkSMS">[선택] 문화센터 광고성 정보 수신 동의(SMS)</label>
									</div>
								</div>
							</div>
							<div class="flex_btn_wrap">
								<a class="b_color_btn gray"
									href="javascript:mypageMember.saveSmsYn()" role="button"> <span>저장</span>
								</a>
							</div>
						</div>
					</div>
					<div class="sub_inner">
						<div class="sub_tit_area">
							<div class="left">
								<p class="f_h2">
									<span class="red_txt">[선택]</span> 차량정보 등록
								</p>
							</div>
							<div class="right"></div>
						</div>
						<div class="info_txt">
							<div class="form_input">
								<input type="text" id="carNoVal"
									oninput="$(this).val($(this).val().replace(/[^(가-힣ㄱ-ㅎㅏ-ㅣㆍᆢ\w)]/gi, ''))"
									maxlength="10" placeholder="차량번호를 입력해주세요." value="">
							...
							<div class="flex_box">
								<div class="form_checkbox">
									<input type="checkbox" id="checkCar"> <label
										for="checkCar">차량번호 수집동의</label>
								</div>
							</div>
						...
						<div class="other_info btn_right">
							<div class="flex_btn_wrap">
								<a class="b_color_btn gray"
									href="javascript:mypageMember.saveCarYn()" role="button"> <span>저장</span>
								</a>
							</div>
						</div>
					</div>
					<div class="sub_inner">
						...
						<div class="info_txt" id="familyList"></div>
						<div class="other_info btn_right">
							<div class="flex_btn_wrap">
								<a class="b_color_btn gray"
									href="javascript:mypageMember.showPopup('#addFamilyPop')"
									role="button"> <span>자녀회원 추가</span>
								</a>
							</div>
						</div>
					</div>
				...
				<div class="func_btn">
					<a href="javascript:mypageMember.drawMember();" class="f_btn">롯데백화점
						문화센터 탈퇴하기</a> <a href="javascript:fnc.moveLogout()" class="f_btn">로그아웃</a>
				</div>
			</div>
		</div>
	</div>
...
<div class="layer_popup add_children" id="addFamilyPop"
	style="display: none">
			...
			<div class="for_padding">
				<div class="scroll_area">
					<form id="addFamilyFrm" method="post">
						<p class="notice_txt f_body2">만 14세 미만의 아동 및 미성년자 수강 시 법정 대리인의
							개인정보 수집 및 취급위탁업무에 동의가 필요합니다.</p>
						<p class="notice_txt f_body2">회원님의 동의를 통해 수집된 동반 수강자의 정보는 수강신청
							및 의사소통의 용도로만 사용됩니다.</p>
						<div class="sub_inner">
							<div class="sub_tit_area">
								<div class="left">
							...
							<div class="data_input_wrap">
								<div class="row">
									...
									<div class="td">
										<div class="form_input">
											<input type="text" name="korNm"
												placeholder="동반 수강자의 이름을 입력해주세요."
												oninput="$(this).val($(this).val().replace(/[^(가-힣ㄱ-ㅎㅏ-ㅣㆍᆢ\w\s\-)]/gi, ''))"
												maxlength="30">
											<div class="input_btn_wrap">
								...
								<div class="row">
									...
									<div class="td">
										<div class="form_input">
											<input type="text" name="bday" inputmode="numeric"
												maxlength="10"
												oninput="$(this).val(fnc.setDateFormat($(this).val()))"
												placeholder="예) 20201023" />
											<div class="input_btn_wrap">
									...
									<div class="td small">
										<div class="radio_flex_box">
											<div class="form_radio">
												<input type="radio" id="gender1" name="sexCd" value="M"
													checked> <label for="gender1">남성</label>
											</div>
											<div class="form_radio">
										...
										<div class="terms_for_msg small">
											<div class="msg_div table_type">
												...
												<div class="caption_txt_w">
													<p class="dot_txt">만 14세 미만의 아동 및 미성년자 가족 수강 시 법정 대리인의
														개인정보 수집 및 취급위탁업무에 동의가 필요합니다.</p>
													<p class="dot_txt">회원님의 동의를 통해 수집된 가족 정보는 수강신청 및 의사소통의
														용도로만 사용됩니다.</p>
												</div>
												<div class="tit_w">
												...
												<div class="txt_box">
															...
															<table>
																...
																<tbody>
																	<tr>
																		...
																		<td class="border_t"><p>가족회원(14세 미만 자녀)의 수강신청
																				시 회원 확인</p></td>
																		<td class="border_t"><p class="bold">동반수강자 삭제
																				시, 문화센터 회원 탈퇴 시</p></td>
																	</tr>
																</tbody>
															</table>
													...
													<p class="info">2. 본인은 롯데백화점 문화센터에 가입하기를 희망하며, 개인정보의
														수집내용을 이해하고 동의합니다.</p>
													<p class="info">3. 가족정보 수집 및 이용 동의에 거부할 수 있으며, 이 경우
														수강신청이 제한됩니다.</p>
												</div>
												<!-- // 2022-12-14 구조수정-->
											</div>
							...
							<div class="dot_txt_box">
								<p class="dot_txt">
									등록 가능 관계 : 만 14세 미만 자녀<br />(14세 이상 자녀는 회원가입을 통해 수강 신청이
									가능합니다.)
								</p>
								<p class="dot_txt">등록 불가능 관계 : 부모(배우자 부모 포함), 부부, 형제, 자매,
									친구, 지인</p>
								<p class="dot_txt">14세 이상 동반 수강자의 경우 동반 수강자가 별도 회원가입 후 데스크
									방문하시어 본인확인 후 진행하셔야 합니다.</p>
							</div>
							<div class="flex_btn_wrap">
...
<script type="text/javascript"
	src="/resources/common/js/member/addFamilyPop.js"></script>
<script type="text/javascript"
	src="/resources/common/js/mypage/mypageMember.js"></script>
