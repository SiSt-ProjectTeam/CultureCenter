...
<html lang="ko">
	<head>
		...
		<meta property="og:url" content="https://culture.lotteshopping.com/mypage/member/info.do" id="og-url-value"/>
...
<script>
	/* function dataImg(){
		...
		imgResizingFn();		
			...
			<div class="m_navi_bar " data-url="/mypage/member/info.do">
	<div class="navi_wrap">
	...
	<!-- 2022-12-05 추가 -->
</div><div class="cont_wrap" id="topDiv">
						...
						<div class="other_info tight_mg">
							<div class="flex_box">
								<div class="form_checkbox">
									<div>
										<input type="checkbox" id="checkMKTG"  onclick = "javascript:mypageMember.blockMKTG()"> 								
										<label for="checkMKTG">[선택] 문화센터 마케팅 활용 동의</label>
									</div>
									<div>
										<input type="checkbox" id="checkSMS"  onclick = "javascript:mypageMember.blockSMS()"> 
					...
					<div class="sub_inner">
						...
						<div class="info_txt">
							<div class="form_input">
								<input type="text" id="carNoVal" oninput="$(this).val($(this).val().replace(/[^(가-힣ㄱ-ㅎㅏ-ㅣㆍᆢ\w)]/gi, ''))" maxlength="10" placeholder="차량번호를 입력해주세요." value="">
								<div class="input_btn_wrap">
