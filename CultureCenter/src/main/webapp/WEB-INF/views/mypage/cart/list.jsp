		...
		<div class="cont_wrap shopbag_w">
			...
			<div class="cont_inner no_pb">
				<div class="page_title_area">
					...
					<div class="txt_wrap">
						<p class="txt f_desc">결제는 지점별로만 가능하며, 장바구니에 담긴 강좌는 최대 30일까지 보관됩니다.</p>
					</div>
						...
						<div class="shopbag_w">
							...
							<div class="utils_box">
								<div class="form_checkbox">
									<input type="checkbox" id="allSelect" name=""
										onclick="mypage_cart.clickAllCheckbox(this)"
										autocomplete="off"> <label for="allSelect">전체선택</label>
								</div>
							...
							<div class="course_history_w" data-mbr-grde-cd=""
								...
								<div class="cour_his_list" data-lect-stlm-amt="80000"
									...
									data-optn-seqno=""
									data-lect-nm="[12/2 외부] 나만의 인생 취미 발견 홍콩 마작 초급"
							...
							<div class="dot_txt_box">
								...
								<p class="dot_txt">수강자가 본인이 아니거나 가족 수강자일 경우, 결제 페이지에서 수강자 변경
									및 추가하실 수 있습니다.</p>
								<!-- 2022-12-09 텍스트 수정 -->
								<p class="dot_txt">강좌 개강 후 ‘현장 상담’을 통해 수강등록 상담을 받으실 수 있습니다.</p>
								<p class="dot_txt">신청하신 강좌는 최소 정원에 미달되거나 사정에 의해 폐강 될 수 있으니
									양해 바랍니다.</p>
							</div>
							<div class="flex_btn_wrap margin_large">
								<a class="border_btn"
									href="/application/search/list.do?type=branch&brchCd=0002">
									<span>강좌 더보기</span>
								</a>
							</div>
						</div>
