...
public class FaqServiceImpl implements FaqService{
	...
	public String createFaqHtml(FaqDTO dto) {
		...
		if (dto.getClCd() >= 0) {faqList = this.getSeacrchFaqList(dto.getClCd(), dto.getQ());}
		...
		if (faqList.isEmpty()) { 
			...
			html.append("               <p class=\"txt f_h2\"><span class=\"srch_value\">")
			.append(dto.getQ()).append("</span>에 대한<br>검색결과가 없어요.</p>\r\n");
			html.append("           </div>\r\n");
			html.append("       </div>\r\n");
			html.append("   </div>\r\n");
			html.append("</div>");
