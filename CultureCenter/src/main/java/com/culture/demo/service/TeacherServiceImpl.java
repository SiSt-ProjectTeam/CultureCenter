...
public class TeacherServiceImpl implements TeacherService{
	...
	public String applyTeacherCheck(TeacherDTO teacherDTO, int memberSq) {
		...
		if (okMap.get("errorCode").equals(2)) {
			...
			html.append("                                            <a class=\"btn_open\" href=\"javascript:\">\r\n");
			html.append("                                                <span>"+teducationDTO.getSchlClCd() == null ? "학교 선택" : (teducationDTO.getSchlClCd().equals("1") ? "고등학교" : teducationDTO.getSchlClCd())+"</span>\r\n");
			html.append("                                            </a>\r\n");
			html.append("                                        </div>\r\n");
			html.append("                                        <div class=\"dimd\"></div>\r\n");
			html.append("                                        <div class=\"list_wrap\">\r\n");
			...
			html.append("                                        </div>\r\n");
			html.append("                                    </div>\r\n");
			html.append("                                    <div class=\"form_select_div "+ (teducationDTO.getGrdtClCd() == null ? "" : "change") +"\">\r\n");
			html.append("                                        <div class=\"open_area\">\r\n");
			html.append("                                            <input type=\"hidden\" id=\"grdtClCd\" name=\"tceduList[][grdtClCd]\" value=\""+ teducationDTO.getGrdtClCd() +"\"/>\r\n");
			html.append("                                            <a class=\"btn_open\" href=\"javascript:\">\r\n");
			html.append("                                                <span>"+ teducationDTO.getGrdtClCd() == null ? "졸업상태 선택" : (teducationDTO.getGrdtClCd().equals("1") ? "졸업" : teducationDTO.getGrdtClCd()) +"</span>\r\n");
			html.append("                                            </a>\r\n");
			html.append("                                        </div>\r\n");
			html.append("                                        <div class=\"dimd\"></div>\r\n");
			html.append("                                        <div class=\"list_wrap\">\r\n");
			...
			html.append("                                        </div>\r\n");
			html.append("                                    </div>\r\n");
			html.append("                                    <div class=\"form_select_div "+ (teducationDTO.getYy() == null ? "" : "change")+" \">\r\n");
			html.append("                                        <div class=\"open_area\">\r\n");
			html.append("                                            <input type=\"hidden\" id=\"yy\" name=\"tceduList[][yy]\" value=\""+ teducationDTO.getYy()+"\"/>\r\n");
			html.append("                                            <a class=\"btn_open\" href=\"javascript:\">\r\n");
			html.append("                                                <span>"+ teducationDTO.getYy() == null ? "년도 선택" : (teducationDTO.getYy().equals("2023") ? "2023" : teducationDTO.getYy()) +"</span>\r\n");
			html.append("                                            </a>\r\n");
			html.append("                                        </div>\r\n");
			html.append("                                        <div class=\"dimd\"></div>\r\n");
			html.append("                                        <div class=\"list_wrap\">\r\n");
			...
			html.append("                                        <input type=\"text\" placeholder=\"학교명을 입력해주세요.\" id=\"schlNm\" name=\"tceduList[][schlNm]\" value=\""+ teducationDTO.getSchlNm()+"\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                <div class=\"input_div\">\r\n");
			html.append("                                    <div class=\"form_input w100p\">\r\n");
			html.append("                                        <input type=\"text\" placeholder=\"전공을 입력해주세요.\" id=\"mjrNm\" name=\"tceduList[][mjrNm]\" value=\""+ teducationDTO.getMjrNm()+"\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                <div class=\"input_div\">\r\n");
			html.append("                                    <div class=\"form_input w100p\">\r\n");
			html.append("                                        <input type=\"text\" placeholder=\"기관명을 입력해주세요.\" id=\"histPlcNm\" name=\"tchistList[][histPlcNm]\" value=\""+ tcareerDTO.getHistPlcNm() +"\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                        <input type=\"text\" maxlength=\"8\" placeholder=\"예) 19980125\" id=\"histStDt\" name=\"tchistList[][histStDt]\" data-type=\"date\" data-old-value=\"\"  value=\""+ tcareerDTO.getHistStDt() +"\" oninput=\"fnc.checkMaxLength(this);\" onkeyup=\"tcCommon.checkNumberOnkeyup(this);\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                        <input type=\"text\" maxlength=\"8\" placeholder=\"예) 19980125\" id=\"histEndDt\" name=\"tchistList[][histEndDt]\" data-type=\"date\" data-old-value=\"\" value=\""+ tcareerDTO.getHistEndDt() +"\"  oninput=\"fnc.checkMaxLength(this);\" onkeyup=\"tcCommon.checkNumberOnkeyup(this);\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                <div class=\"input_div\">\r\n");
			html.append("                                    <div class=\"form_input w100p\">\r\n");
			html.append("                                        <input type=\"text\" id=\"awrdIssueAgncNm\" name=\"tcawrdList[][issueAgncNm]\" value=\""+tawardsDTO.getIssueAgncNm()+"\" placeholder=\"발행기관을 입력해주세요.\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                <div class=\"input_div\">\r\n");
			html.append("                                    <div class=\"form_input w100p\">\r\n");
			html.append("                                        <input type=\"text\" id=\"awrdIssueNm\" name=\"tcawrdList[][issueNm]\" value=\""+ tawardsDTO.getIssueNm()+"\"  placeholder=\"수상내역을 입력해주세요.\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                        <input type=\"text\" maxlength=\"8\" id=\"awrdIssueDt\" name=\"tcawrdList[][issueDt]\" value=\""+ tawardsDTO.getIssueDt()+"\"  placeholder=\"예) 19980125\" data-type=\"date\" data-old-value=\"\" oninput=\"fnc.checkMaxLength(this);\" onkeyup=\"tcCommon.checkNumberOnkeyup(this);\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                <div class=\"input_div\">\r\n");
			html.append("                                    <div class=\"form_input w100p\">\r\n");
			html.append("                                        <input type=\"text\" id=\"athctfIssueAgncNm\" name=\"tcauthctfList[][issueAgncNm]\" value=\""+ tcertificateDTO.getIssueAgncNm()+"\" placeholder=\"발행기관을 입력해주세요.\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			html.append("                                            <button type=\"button\" class=\"btn_delete\" title=\"발행기관 지우기\"></button>\r\n");
			html.append("                                        </div>\r\n");
			html.append("                                    </div>\r\n");
			...
			html.append("                                <div class=\"input_div\">\r\n");
			html.append("                                    <div class=\"form_input w100p\">\r\n");
			html.append("                                        <input type=\"text\" id=\"athctfIssueNm\" name=\"tcauthctfList[][issueNm]\" value=\""+ tcertificateDTO.getIssueNm()+"\" placeholder=\"자격증명을 입력해주세요.\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                                        <input type=\"text\" maxlength=\"8\" id=\"athctfIssueDt\" name=\"tcauthctfList[][issueDt]\" value=\""+tcertificateDTO.getIssueDt()+"\" placeholder=\"예) 19980125\" data-old-value=\"\" oninput=\"fnc.checkMaxLength(this);\" onkeyup=\"tcCommon.checkNumberOnkeyup(this);\">\r\n");
			html.append("                                        <div class=\"input_btn_wrap\">\r\n");
			...
			html.append("                            <div class=\"form_textarea\">\r\n");
			html.append("                                <div class=\"wrap_for_msg\">\r\n");
			html.append("                                    <textarea name=\"lectIntrdnCont\" id=\"\" cols=\"\" rows=\"\" placeholder=\"본인의 강좌에 대한 소개 내용을 간략히 작성해주세요.\" data-maxlength=\"200\" onkeyup=\"tcCommon.textareaOnkeyup(this)\">"+ dto.getLectIntrdnCont() == null ? "" : dto.getLectIntrdnCont() +"</textarea>\r\n");
			html.append("                                </div>\r\n");
			html.append("                                <p class=\"check_byte\">\r\n");
			html.append("                                    <span class=\"r_byte\">0</span>\r\n");
			html.append("                                    /\r\n");
			...
			html.append("        <div class=\"form_select_div change\">\r\n");
			html.append("            <div class=\"open_area\">\r\n");
			html.append("                <input type=\"hidden\" name=\"tceduList[][schlClCd]\" value=\""+ teducationDTO.getSchlClCd()+"\"/>\r\n");
			html.append("                <a class=\"btn_open\" href=\"javascript:\">\r\n");
			html.append("                    <span>"+ teducationDTO.getSchlClCd() == null ? "학교 선택" : teducationDTO.getSchlClCd().equals("1") ? "고등학교" : teducationDTO.getSchlClCd()+"</span>\r\n");
			html.append("                </a>\r\n");
			html.append("            </div>\r\n");
			...
			html.append("    <div class=\"input_div\">\r\n");
			html.append("        <div class=\"form_input w100p\">\r\n");
			html.append("            <input type=\"text\" placeholder=\"학교명을 입력해주세요.\" name=\"tceduList[][schlNm]\" value=\"$"+ teducationDTO.getSchlNm() +"$\">\r\n");
			html.append("            <div class=\"input_btn_wrap\">\r\n");
			html.append("                <button type=\"button\" class=\"btn_delete\" title=\"학교명 지우기\"></button>\r\n");
			html.append("            </div>\r\n");
			html.append("        </div>\r\n");
			...
			html.append("    <div class=\"input_div\">\r\n");
			html.append("        <div class=\"form_input w100p\">\r\n");
			html.append("            <input type=\"text\" placeholder=\"기관명을 입력해주세요.\" name=\"tchistList[][histPlcNm]\" value=\"$"+ tcareerDTO.getHistPlcNm() +"$\">\r\n");
			html.append("            <div class=\"input_btn_wrap\">\r\n");
			html.append("                <button type=\"button\" class=\"btn_delete\" title=\"기관명 지우기\"></button>\r\n");
			html.append("            </div>\r\n");
			html.append("        </div>\r\n");
