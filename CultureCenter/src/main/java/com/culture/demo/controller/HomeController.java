...
public class HomeController {
	...
	public ResponseEntity<String> getMainLectList(@RequestBody MainLectSearchDTO mainLectSearchDTO, HttpServletRequest request, Principal principal) throws Exception {
		...
		int branch_id = 0;
		if (principal != null) {
			branch_id = this.memberService.getMypageInfo(principal.getName())
					.getBranch_id();
		}
